...
Transaction.MAX_MONEY = 18181818 * 1e8; // Litecoin has 84M coins
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://unifycore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by unifycore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a unifycore Address object. The
 * same is true for `script`, which can be a string or a unifycore Script.
 *
