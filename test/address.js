...
describe('Address', function() {
  ...
  var str = 'UeHMysdXKFu2XwpodRhaPZb5CpuRRR7YtZ';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash UeHMysdXKFu2XwpodRhaPZb5CpuRRR7YtZ', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: UeHMysdXKFu2XwpodRhaPZb5CpuRRR7YtZ, type: pubkeyhash, network: livenet>';
