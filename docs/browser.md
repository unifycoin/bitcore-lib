...
<head>
  <meta charset="utf-8">
  <script src="bower_components/unifycore/unifycore-lib.min.js"></script>
...
<body>
  ...
  <script type="text/javascript">
    var unifycore = require('unifycore-lib');
...
```sh
browserify --require ./index.js:unifycore-lib | uglifyjs > unifycore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external unifycore-lib | uglifyjs > bitcore-mnemonic.min.js
```
